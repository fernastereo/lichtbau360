...
function lichtbau360_files() {
  ...
  wp_enqueue_style('lichtbau360_propiedades_styles', get_theme_file_uri('/css/propiedades.css'));
  ...
  wp_enqueue_script('lichtbau360_hover-imagen_js', get_theme_file_uri('/build/hover-imagen.js'), array('jquery'), '1.0', true);
}
